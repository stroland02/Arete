...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden">
      ...
      <div className="glass-panel max-w-sm w-full p-8 flex flex-col items-center gap-6 text-center bg-white/5 border border-white/10 rounded-2xl">
        ...
        >
          <button
            type="submit"
            className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-medium text-white bg-indigo-500/20 border border-indigo-500/30 hover:bg-indigo-500/30 transition-colors"
          >
