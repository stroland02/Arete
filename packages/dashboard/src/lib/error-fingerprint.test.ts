...
describe('normalizeErrorMessage', () => {
  ...
  it('matches the webhook normalizer it mirrors, rule for rule', () => {
    // packages/webhook/src/fingerprint.ts applies the same list in the same
    // order; if this ever diverges, grouping means two things in one product.
