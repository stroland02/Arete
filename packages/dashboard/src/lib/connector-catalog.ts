...
export const CONNECTORS: ConnectorDef[] = [
  {
    ...
    authSummary: "Uses the GitHub App installation you already granted Areté. No new credential to store.",
    trustNote: "No new token is created or stored — Areté reuses the same installation-scoped access it already has for reviewing this repo.",
    status: "available",
    connected: false,
  },
  {
