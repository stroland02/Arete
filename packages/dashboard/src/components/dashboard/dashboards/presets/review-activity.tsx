  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      <div className="lg:col-span-2">
        <TimeseriesWidget title="Reviews over time" caption={connected ? `last ${days} days` : undefined} dates={model.reviewDates} days={days} skeleton={skeleton} />
      </div>
      ...
      <MetricWidget label="Reviews this week" value={model.recentReviews} icon={<IconClockHour4 className="h-5 w-5 text-accent-secondary" />} change={connected ? weekChange : undefined} positive={model.weeklyDelta >= 0} skeleton={skeleton} />
