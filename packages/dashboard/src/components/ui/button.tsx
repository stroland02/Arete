  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary/50 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-surface-2 text-content-primary border border-border-default hover:bg-content-primary/5",
        ghost: "text-content-muted hover:text-content-primary hover:bg-content-primary/5",
        icon: "text-content-muted hover:text-content-primary hover:bg-content-primary/5",
      },
      size: {
        default: "h-10 px-4",
        sm: "h-8 px-3 text-xs",
